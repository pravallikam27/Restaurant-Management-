...
class RMS:
    ...
    def __init__ (self, root):
        ...
        #===btn_logout===
        btn_logout=Button(self.root,command=self.logout, text="Logout", font=("times new roman",15,"bold"), bg = "yellow", cursor="hand2").place(x=1150,y= 10,height=50,width=100)
        #===clock====
        ...
        btm_supplier= Button(LeftMenu, text="Supplier",command=self.supplier, image=self.icon_side,compound=LEFT,padx=10, anchor="w",font=("times new roman",20,"bold"), bg = "white", bd = 3, cursor="hand2",height=44).pack(side="top",fill=X)
        btm_category= Button(LeftMenu, text="Category",command = self.category, image=self.icon_side,compound=LEFT,padx=10, anchor="w", font=("times new roman",20,"bold"), bg = "white", bd = 3, cursor="hand2",height=44).pack(side="top",fill=X)
        btm_product= Button(LeftMenu, text="Dishes", command=self.product,image=self.icon_side,compound=LEFT,padx=10, anchor="w",font=("times new roman",20,"bold"), bg = "white", bd = 3, cursor="hand2",height=44).pack(side="top",fill=X)
        btm_billing = Button(LeftMenu, text="Billing", command=self.billing,image=self.icon_side,compound=LEFT,padx=10, anchor="w",font=("times new roman",20,"bold"), bg = "white", bd = 3, cursor="hand2",height=44).pack(side="top",fill=X)
        btm_sales= Button(LeftMenu, text="All Bills",command=self.sales, image=self.icon_side,compound=LEFT,padx=10, anchor="w",font=("times new roman",20,"bold"), bg = "white", bd = 3, cursor="hand2",height=44).pack(side="top",fill=X)
        btm_exit= Button(LeftMenu, text="Exit",command=self.exit, image=self.icon_side,compound=LEFT,padx=10, anchor="w",font=("times new roman",20,"bold"), bg = "white", bd = 3, cursor="hand2",height=44).pack(side="top",fill=X)
